...
gallery.insertAdjacentHTML("beforeend", createGalery((0, _galleryItems.galleryItems)));
// gallery.addEventListener('click', openImage);
function createGalery(gallery1) {
    return gallery1.map(({ preview , original , description  })=>{
        return `
